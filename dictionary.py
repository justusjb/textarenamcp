"""
English dictionary utilities for the SpellingBee agent.
"""
import re
import logging
...
class EnglishDictionary:
    ...
    def _load_dic(
        ...
        try:
            ...
            logger.error(f"Error loading dictionary file {filename}: {str(e)}")
            return set()
    ...
    def _load_nltk(self, basic: bool) -> set[str]:
        try:
            ...
            logger.error(f"Error loading NLTK words: {str(e)}")
            return set()
